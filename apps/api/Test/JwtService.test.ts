...
describe("JwtService Tests", () => {
	...
	describe("verify", () => {
		...
		it("should return null for expired token", () => {
			...
			const expiredToken = jwt.sign({ sub: "123" }, TEST_SECRET, {
		...
		it("should return null for token with wrong issuer", () => {
			const wrongIssuerToken = jwt.sign({ sub: "123" }, TEST_SECRET, {
				expiresIn: "1h",
				algorithm: "HS256",
				issuer: "wrong-issuer",
				audience: "test-audience",
		...
		it("should return null for token with wrong audience", () => {
			const wrongAudienceToken = jwt.sign({ sub: "123" }, TEST_SECRET, {
				expiresIn: "1h",
				algorithm: "HS256",
				issuer: "test-issuer",
