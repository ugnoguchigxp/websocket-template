...
export const NotificationToast = React.memo(({ notification, onClose, onHide }) => {
    ...
    return (<div id={`notification-toast-${notification.id}`} className={`
        notification-toast
      ...
      `} role="alert" aria-live="polite" aria-atomic="true">
				...
				{notification.duration > 0 && (<div className="absolute top-0 left-0 h-1 bg-black bg-opacity-10 w-full">
						<div className="h-full bg-black bg-opacity-20 animate-pulse" style={{
