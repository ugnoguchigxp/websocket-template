  ...
  it('can clear all toasts through context', () => {
    const TestComponentWithClear: React.FC = () => {
      ...
      return (
        <div>
          <button onClick={() => {
            if ('clearAllToasts' in context && typeof (context as any).clearAllToasts === 'function') {
              (context as any).clearAllToasts();
            }
          }}>
            Clear All
  ...
  it('can toggle notification center', () => {
    const TestComponentWithToggle: React.FC = () => {
      ...
      return (
        <div>
          <button onClick={() => {
            if ('toggleNotificationCenter' in context && typeof (context as any).toggleNotificationCenter === 'function') {
              (context as any).toggleNotificationCenter();
            }
          }}>
            Toggle Center
