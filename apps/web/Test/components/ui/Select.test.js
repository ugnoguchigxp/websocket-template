...
describe('Select Component', () => {
    ...
    it('renders select with default props', () => {
        ...
        <SelectContent>
          {defaultProps.options.map((option) => (<SelectItem key={option.value} value={option.value}>
              {option.label}
            </SelectItem>))}
        </SelectContent>
      </Select>);
    ...
    it('handles empty options array', () => {
        renderWithProviders(<Select {...defaultProps} options={[]}>
        <SelectTrigger>
          <SelectValue />
        </SelectTrigger>
        <SelectContent />
    ...
    it('handles null value', () => {
        renderWithProviders(<Select {...defaultProps} value={null}>
        <SelectTrigger>
          <SelectValue />
        </SelectTrigger>
        <SelectContent>
