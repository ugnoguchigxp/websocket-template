...
describe('Textarea Component', () => {
    ...
    it('supports form validation attributes', () => {
        renderWithProviders(<Textarea required minLength={10} maxLength={500} pattern="[A-Za-z0-9\s]+" title="Alphanumeric characters only"/>);
        const textarea = screen.getByRole('textbox');
        expect(textarea).toBeRequired();
    ...
    it('supports ARIA attributes', () => {
        renderWithProviders(<Textarea aria-label="Message input" aria-describedby="message-help" aria-invalid="false" aria-required="true"/>);
