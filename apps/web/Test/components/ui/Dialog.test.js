...
import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger, DialogClose, DialogOverlay, } from '../../../src/components/ui/Dialog';
// Setup Radix mocks
...
describe('Dialog Component', () => {
    ...
    it('renders dialog content when open', () => {
        renderWithProviders(<Dialog {...defaultProps} open={true}>
        <DialogTrigger asChild>
          <button>Open Dialog</button>
        </DialogTrigger>
        <DialogContent>
