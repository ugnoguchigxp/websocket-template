...
describe('Input Component', () => {
    ...
    it('supports form validation attributes', () => {
        renderWithProviders(<Input required minLength={3} maxLength={10} pattern="[A-Za-z]{3}" title="Three letter code"/>);
        const input = screen.getByRole('textbox');
        expect(input).toBeRequired();
    ...
    it('supports ARIA attributes', () => {
        renderWithProviders(<Input aria-label="Search" aria-describedby="search-help" aria-invalid="false"/>);
