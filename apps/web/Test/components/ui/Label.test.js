...
describe('Label Component', () => {
    ...
    it('supports accessibility attributes', () => {
        renderWithProviders(<Label id="test-label-id" aria-label="Screen reader label" aria-describedby="description-id">
        Accessible Label
      </Label>);
    ...
    it('passes through data-* attributes', () => {
        renderWithProviders(<Label data-testid="test-label" data-custom="value">
        Label with Data
      </Label>);
