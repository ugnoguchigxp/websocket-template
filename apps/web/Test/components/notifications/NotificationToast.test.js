...
describe('NotificationToast Component', () => {
    ...
    it('renders notification with title and message', () => {
        ...
        renderWithProviders(<NotificationToast notification={notification} onClose={mockOnClose} onHide={mockOnHide}/>);
    ...
    it('displays correct icon for notification type', () => {
        ...
        types.forEach(type => {
            const { unmount } = renderWithProviders(<NotificationToast notification={createMockNotification({ type })} onClose={mockOnClose} onHide={mockOnHide}/>);
