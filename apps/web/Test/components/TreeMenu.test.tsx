...
import type { TreeNode } from "../../src/constants/menu"
...
const renderTreeMenu = (component: React.ReactElement) => {
...
describe("TreeMenu Component", () => {
	...
	it("uses translated labels when labelKey is provided", () => {
		const menuDataWithKeys: TreeNode[] = [
			{
				id: "test",
				label: "Test Label",
				labelKey: "test_key",
